...
export default function ExcelComparePage() {
  ...
  return (
    <div className={myui.main}>
      <MyuiPanel title="رفع الملفات" icon={ArrowLeftRight}>
          ...
          return (
            <div key={slot}>
              ...
              {loaded ? (
                ...
                <label htmlFor={id}
                  className={cn(myui.uploadZone, "p-6", color)}>
      ...
      {fileA && fileB && (
        <MyuiPanel title="إعدادات المقارنة" icon={ArrowLeftRight}>
        <div className="flex flex-col sm:flex-row sm:items-end gap-3">
          ...
          <Button onClick={compare} disabled={!keyCol} className="gap-2 bg-cyan-600 hover:bg-cyan-700 text-white w-full sm:w-auto">
      ...
      {diff && counts && (
        <MyuiPanel title="نتائج المقارنة" icon={ArrowLeftRight}>
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap items-center gap-3 justify-between">
            ...
            <div className="flex gap-2">
              ...
              <Button size="sm" onClick={exportDiff} className="gap-2 bg-cyan-600 hover:bg-cyan-700 text-white">
          ...
          {/* Diff table */}
          <div className={cn(myui.tableWrap, "max-h-[500px] overflow-auto")}>
            <Table>
              <TableHeader>
                <TableRow className="bg-slate-50 dark:bg-slate-800/50 hover:bg-slate-50">
                  <TableHead className="whitespace-nowrap text-start font-semibold w-20">الحالة</TableHead>
                  {allHeaders.map((h) => (
